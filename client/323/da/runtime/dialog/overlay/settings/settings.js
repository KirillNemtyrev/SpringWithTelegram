var settings = {
    ...
    read: function(input) {
        ...
        try {
            settings.profile = input.readString(255);
        } catch (e) {
    ...
    write: function(output) {
        ...
        output.writeString(settings.profile, 255);
    ...
    initOverlay: function() {
		...
		*/
        ...
        settings.dirLabel.setOnAction(function(event) app.getHostServices().showDocument(settings.updatesDir.toUri()));
