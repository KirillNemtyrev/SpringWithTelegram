...
function initVoteDialog(stage, data) {
    ...
    //Case
    var caseImage = createImageFromUrl(Launcher.getResourceURL("dialog/styles/vote/img/case-default.png"));
    ...
    data.get("tops").forEach(function (v) {
        ...
        tops.push({
            ...
            url: v.getString("url", ""),
            //img: v.getString("img", "")
            img: Launcher.getResourceURL("dialog/styles/vote/img/emerald.gif").toString()
        });
    });
